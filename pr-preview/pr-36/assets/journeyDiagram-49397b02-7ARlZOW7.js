...
`,P=function(e,t){return g(e,t)},F=function(e,t){let n=e.append(`circle`).attr(`cx`,t.cx).attr(`cy`,t.cy).attr(`class`,`face`).attr(`r`,15).attr(`stroke-width`,2).attr(`overflow`,`visible`),r=e.append(`g`);r.append(`circle`).attr(`cx`,t.cx-15/3).attr(`cy`,t.cy-15/3).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`),r.append(`circle`).attr(`cx`,t.cx+15/3).attr(`cy`,t.cy-15/3).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`);function i(e){let n=m().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(15/2).outerRadius(15/2.2);e.append(`path`).attr(`class`,`mouth`).attr(`d`,n).attr(`transform`,`translate(`+t.cx+`,`+(t.cy+2)+`)`)}function a(e){let n=m().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(15/2).outerRadius(15/2.2);e.append(`path`).attr(`class`,`mouth`).attr(`d`,n).attr(`transform`,`translate(`+t.cx+`,`+(t.cy+7)+`)`)}function o(e){e.append(`line`).attr(`class`,`mouth`).attr(`stroke`,2).attr(`x1`,t.cx-5).attr(`y1`,t.cy+7).attr(`x2`,t.cx+5).attr(`y2`,t.cy+7).attr(`class`,`mouth`).attr(`stroke-width`,`1px`).attr(`stroke`,`#666`)}return t.score>3?i(r):t.score<3?a(r):o(r),n},I=function(e,t){let n=e.append(`circle`);return n.attr(`cx`,t.cx),n.attr(`cy`,t.cy),n.attr(`class`,`actor-`+t.pos),n.attr(`fill`,t.fill),n.attr(`stroke`,t.stroke),n.attr(`r`,t.r),n.class!==void 0&&n.attr(`class`,n.class),t.title!==void 0&&n.append(`title`).text(t.title),n},L=function(e,t){return h(e,t)},R=function(e,t){function n(e,t,n,r,i){return e+`,`+t+` `+(e+n)+`,`+t+` `+(e+n)+`,`+(t+r-i)+` `+(e+n-i*1.2)+`,`+(t+r)+` `+e+`,`+(t+r)}let r=e.append(`polygon`);r.attr(`points`,n(t.x,t.y,50,20,7)),r.attr(`class`,`labelBox`),t.y+=t.labelMargin,t.x+=.5*t.labelMargin,L(e,t)},z=function(e,t,n){let r=e.append(`g`),i=_();i.x=t.x,i.y=t.y,i.fill=t.fill,i.width=n.width*t.taskCount+n.diagramMarginX*(t.taskCount-1),i.height=n.height,i.class=`journey-section section-type-`+t.num,i.rx=3,i.ry=3,P(r,i),U(n)(t.text,r,i.x,i.y,i.width,i.height,{class:`journey-section section-type-`+t.num},n,t.colour)},B=-1,V=function(e,t,n){let r=t.x+n.width/2,i=e.append(`g`);B++,i.append(`line`).attr(`id`,`task`+B).attr(`x1`,r).attr(`y1`,t.y).attr(`x2`,r).attr(`y2`,450).attr(`class`,`task-line`).attr(`stroke-width`,`1px`).attr(`stroke-dasharray`,`4 2`).attr(`stroke`,`#666`),F(i,{cx:r,cy:300+(5-t.score)*30,score:t.score});let a=_();a.x=t.x,a.y=t.y,a.fill=t.fill,a.width=n.width,a.height=n.height,a.class=`task task-type-`+t.num,a.rx=3,a.ry=3,P(i,a);let o=t.x+14;t.people.forEach(e=>{let n=t.actors[e].color;I(i,{cx:o,cy:t.y,r:7,fill:n,stroke:`#000`,title:e,pos:t.actors[e].position}),o+=10}),U(n)(t.task,i,a.x,a.y,a.width,a.height,{class:`task`},n,t.colour)},H=function(e,t){v(e,t)},U=function(){function e(e,t,n,i,a,o,s,c){r(t.append(`text`).attr(`x`,n+a/2).attr(`y`,i+o/2+5).style(`font-color`,c).style(`text-anchor`,`middle`).text(e),s)}function t(e,t,n,i,a,o,s,c,l){let{taskFontSize:u,taskFontFamily:d}=c,f=e.split(/<br\s*\/?>/gi);for(let e=0;e<f.length;e++){let c=e*u-u*(f.length-1)/2,p=t.append(`text`).attr(`x`,n+a/2).attr(`y`,i).attr(`fill`,l).style(`text-anchor`,`middle`).style(`font-size`,u).style(`font-family`,d);p.append(`tspan`).attr(`x`,n+a/2).attr(`dy`,c).text(f[e]),p.attr(`y`,i+o/2).attr(`dominant-baseline`,`central`).attr(`alignment-baseline`,`central`),r(p,s)}}function n(e,n,i,a,o,s,c,l){let u=n.append(`switch`),d=u.append(`foreignObject`).attr(`x`,i).attr(`y`,a).attr(`width`,o).attr(`height`,s).attr(`position`,`fixed`).append(`xhtml:div`).style(`display`,`table`).style(`height`,`100%`).style(`width`,`100%`);d.append(`div`).attr(`class`,`label`).style(`display`,`table-cell`).style(`text-align`,`center`).style(`vertical-align`,`middle`).text(e),t(e,u,i,a,o,s,c,l),r(d,c)}function r(e,t){for(let n in t)n in t&&e.attr(n,t[n])}return function(r){return r.textPlacement===`fo`?n:r.textPlacement===`old`?e:t}}(),W={drawRect:P,drawCircle:I,drawSection:z,drawText:L,drawLabel:R,drawTask:V,drawBackgroundRect:H,initGraphics:function(e){e.append(`defs`).append(`marker`).attr(`id`,`arrowhead`).attr(`refX`,5).attr(`refY`,2).attr(`markerWidth`,6).attr(`markerHeight`,4).attr(`orient`,`auto`).append(`path`).attr(`d`,`M 0,0 V 4 L6,2 Z`)}},G=function(e){Object.keys(e).forEach(function(t){J[t]=e[t]})},K={};function q(e){let t=o().journey,n=60;Object.keys(K).forEach(r=>{let i=K[r].color,a={cx:20,cy:n,r:7,fill:i,stroke:`#000`,pos:K[r].position};W.drawCircle(e,a);let o={x:40,y:n+7,fill:`#666`,text:r,textMargin:t.boxTextMargin|5};W.drawText(e,o),n+=20})}var J=o().journey,Y=J.leftMargin,te=function(e,t,n,r){let i=o().journey,a=o().securityLevel,c;a===`sandbox`&&(c=s(`#i`+t));let l=s(a===`sandbox`?c.nodes()[0].contentDocument.body:`body`);X.init();let u=l.select(`#`+t);W.initGraphics(u);let f=r.db.getTasks(),p=r.db.getDiagramTitle(),m=r.db.getActors();for(let e in K)delete K[e];let h=0;m.forEach(e=>{K[e]={color:i.actorColours[h%i.actorColours.length],position:h},h++}),q(u),X.insert(0,0,Y,Object.keys(K).length*50),ne(u,f,0);let g=X.getBounds();p&&u.append(`text`).text(p).attr(`x`,Y).attr(`font-size`,`4ex`).attr(`font-weight`,`bold`).attr(`y`,25);let _=g.stopy-g.starty+2*i.diagramMarginY,v=Y+g.stopx+2*i.diagramMarginX;d(u,_,v,i.useMaxWidth),u.append(`line`).attr(`x1`,Y).attr(`y1`,i.height*4).attr(`x2`,v-Y-4).attr(`y2`,i.height*4).attr(`stroke-width`,4).attr(`stroke`,`black`).attr(`marker-end`,`url(#arrowhead)`);let y=p?70:0;u.attr(`viewBox`,`${g.startx} -25 ${v} ${_+y}`),u.attr(`preserveAspectRatio`,`xMinYMin meet`),u.attr(`height`,_+y+25)},X={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(e,t,n,r){e[t]===void 0?e[t]=n:e[t]=r(n,e[t])},updateBounds:function(e,t,n,r){let i=o().journey,a=this,s=0;function c(o){return function(c){s++;let l=a.sequenceItems.length-s+1;a.updateVal(c,`starty`,t-l*i.boxMargin,Math.min),a.updateVal(c,`stopy`,r+l*i.boxMargin,Math.max),a.updateVal(X.data,`startx`,e-l*i.boxMargin,Math.min),a.updateVal(X.data,`stopx`,n+l*i.boxMargin,Math.max),o!==`activation`&&(a.updateVal(c,`startx`,e-l*i.boxMargin,Math.min),a.updateVal(c,`stopx`,n+l*i.boxMargin,Math.max),a.updateVal(X.data,`starty`,t-l*i.boxMargin,Math.min),a.updateVal(X.data,`stopy`,r+l*i.boxMargin,Math.max))}}this.sequenceItems.forEach(c())},insert:function(e,t,n,r){let i=Math.min(e,n),a=Math.max(e,n),o=Math.min(t,r),s=Math.max(t,r);this.updateVal(X.data,`startx`,i,Math.min),this.updateVal(X.data,`starty`,o,Math.min),this.updateVal(X.data,`stopx`,a,Math.max),this.updateVal(X.data,`stopy`,s,Math.max),this.updateBounds(i,o,a,s)},bumpVerticalPos:function(e){this.verticalPos+=e,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},Z=J.sectionFills,Q=J.sectionColours,ne=function(e,t,n){let r=o().journey,i=``,a=n+(r.height*2+r.diagramMarginY),s=0,c=`#CCC`,l=`black`,u=0;for(let[n,o]of t.entries()){if(i!==o.section){c=Z[s%Z.length],u=s%Z.length,l=Q[s%Q.length];let a=0,d=o.section;for(let e=n;e<t.length&&t[e].section==d;e++)a+=1;let f={x:n*r.taskMargin+n*r.width+Y,y:50,text:o.section,fill:c,num:u,colour:l,taskCount:a};W.drawSection(e,f,r),i=o.section,s++}let d=o.people.reduce((e,t)=>(K[t]&&(e[t]=K[t]),e),{});o.x=n*r.taskMargin+n*r.width+Y,o.y=a,o.width=r.diagramMarginX,o.height=r.diagramMarginY,o.colour=l,o.fill=c,o.num=u,o.actors=d,W.drawTask(e,o,r),X.insert(o.x,o.y,o.x+o.width+r.taskMargin,450)}},$={setConf:G,draw:te},re={parser:b,db:M,renderer:$,styles:N,init:e=>{$.setConf(e.journey),M.clear()}};export{re as diagram};